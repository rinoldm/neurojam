    ...
    if (this.#menuView === null) {
      ...
      creditsText.innerHTML = `
        A game by maxdefolsch and demurgos.<br><br>
            ...
            Minor AI assistance: NovelAI (base of Neuro sprite), Copilot (code tidbits)<br>
            Tileset: <a href="https://pzuh.itch.io/the-pyramid-platformer-tileset">"The pyramid platformer tileset" by Pzuh</a>
      `;
